...
app.post('https://authpage-coral.vercel.app/predict', (req, res) => {
...
// Signup Route
app.post('https://authpage-coral.vercel.app/signup', async (req, res) => {
...
// Login Route
app.post('https://authpage-coral.vercel.app/login', async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({
            ...
            redirectUrl: 'https://hs-code-hosting-master.vercel.app', // Updated redirect URL
        });
    } catch (error) {
